...
limiter = Limiter(
    ...
    key_prefix="iappc_admin_portal_rate_limit",
)
...
class GlobalRateLimiter:
    ...
    def __init__(
        ...
        key_prefix: str = "iappc_admin_portal_global_rate_limit",
    ):
        """
...
global_rate_limiter = GlobalRateLimiter(
    ...
    max_requests=100,  # Global limit: 200 requests per minute
    window_seconds=60,  # Time window: 1 minute
    key_prefix="iappc_admin_portal_global:global",
)
